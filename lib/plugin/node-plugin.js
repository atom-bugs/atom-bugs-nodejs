...
var NodePlugin = (function (_super) {
    ...
    NodePlugin.prototype.start = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var projectPath, socketUrl, _a, editor, e_1;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case node_options_1.Runtype.Remote: return [3, 4];
                        }
                        return [3, 6];
                    case 1:
                        ...
                        if (!lodash_1.isString(this.launcher.scriptPath)) return [3, 3];
                    ...
                    case 6:
                        ...
                        return [4, this
                                ...
                                .connect(socketUrl)
                                .then(function () {
                                _this.pluginClient.status.update('Debugger attached');
                    ...
                    case 9:
                        e_1 = _b.sent();
                        this.pluginClient.status.update(e_1);
