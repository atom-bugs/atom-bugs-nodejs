...
var NodeDebugger = (function () {
    ...
    NodeDebugger.prototype.onDidPause = function (cb) {
        return this.emitter.on('didPause', cb);
    };
    NodeDebugger.prototype.onDidPauseOnLocation = function (cb) {
        return this.emitter.on('didPauseOnLocation', cb);
    };
    NodeDebugger.prototype.onDidResume = function (cb) {
        return this.emitter.on('didResume', cb);
    };
    NodeDebugger.prototype.onDidException = function (cb) {
        return this.emitter.on('didException', cb);
    };
    NodeDebugger.prototype.onDidAddScript = function (cb) {
        return this.emitter.on('didAddScript', cb);
    };
    NodeDebugger.prototype.onDidLoadFile = function (cb) {
        return this.emitter.on('didLoadFile', cb);
    };
    NodeDebugger.prototype.getScriptOriginalLocation = function (script, location) {
        var fileLocation = {
            filePath: script.url,
    ...
    NodeDebugger.prototype.getGeneratedLocation = function (location) {
        console.log('generated', location);
    };
    NodeDebugger.prototype.pauseOnScriptLocation = function (script, location) {
        var pausedLocation = this.getScriptOriginalLocation(script, location);
        this.emitter.emit('didPauseOnLocation', pausedLocation);
    };
    NodeDebugger.prototype.scriptDidLoad = function (cb) {
        var _this = this;
    ...
    NodeDebugger.prototype.setup = function () {
        var _this = this;
        ...
        Debugger.paused(function (params) {
            var frames = lodash_1.get(params, 'callFrames', []);
            var location = lodash_1.get(frames, '[0].location', {});
            if (location) {
                _this
                    .scriptDidLoad(function (script) {
                    return location.scriptId === script.scriptId;
                })
                    .then(function (script) {
                    _this.pauseOnScriptLocation(script, location);
                });
            }
            _this.emitter.emit('didPause');
        });
    ...
    NodeDebugger.prototype.addSourceMap = function (params) {
    ...
    NodeDebugger.prototype.loadScript = function (fileUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var fileExists;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    NodeDebugger.prototype.addScript = function (script) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
    ...
    NodeDebugger.prototype.requestIfRunning = function (cb) {
        if (this.isRunning) {
            return cb(this.protocol.getDomains());
        }
        return Promise.resolve();
    };
    NodeDebugger.prototype.addBreakpoint = function (breakpoint) {
        var _this = this;
    ...
    NodeDebugger.prototype.removeBreakpoint = function (breakpoint) {
        var _this = this;
        return this.requestIfRunning(function (_a) {
            var Debugger = _a.Debugger;
    ...
    NodeDebugger.prototype.resume = function () {
        return this.requestIfRunning(function (_a) {
            var Debugger = _a.Debugger;
            return Debugger.resume();
        });
    };
    NodeDebugger.prototype.pause = function () {
        return this.requestIfRunning(function (_a) {
            var Debugger = _a.Debugger;
            return Debugger.pause();
        });
    };
    NodeDebugger.prototype.stepOver = function () {
        return this.requestIfRunning(function (_a) {
            var Debugger = _a.Debugger;
            return Debugger.stepOver();
        });
    };
    NodeDebugger.prototype.stepInto = function () {
        return this.requestIfRunning(function (_a) {
            var Debugger = _a.Debugger;
            return Debugger.stepInto();
        });
    };
    NodeDebugger.prototype.stepOut = function () {
        return this.requestIfRunning(function (_a) {
            var Debugger = _a.Debugger;
            return Debugger.stepOut();
        });
    };
    NodeDebugger.prototype.attach = function (hostname, port) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var sockets, socket;
            return __generator(this, function (_a) {
    ...
    NodeDebugger.prototype.dettach = function () {
        if (this.protocol) {
    ...
    NodeDebugger.prototype.getSockets = function (hostname, port, attempts) {
        var _this = this;
        return new Promise(function (resolve, reject) {
